            ...
            <div class="photo-details-card">
                    ...
                    <div class="detail-section">
                        <div class="share-section">
                            ...
                            <div class="share-input-group">
                                <input type="text" class="share-input" value="{{ route('media.share', $photo->share_token) }}" readonly id="shareLink">
                ...
                <div class="action-buttons">
                    ...
                    @if($photo->user_id === auth()->id())
                        <a href="{{ route('media.edit', $photo->filename) }}?from={{ request()->get('from') }}&org={{ request()->get('org') }}" class="action-btn" style="background: #007bff; color: white;">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <a href="{{ route('media.download', $photo->filename) }}" class="btn btn-success">
        ...
        <div class="modal-content">
            <div class="modal-header border-0">
                <h5 class="modal-title text-danger" id="deleteModalLabel">
                    <i class="bi bi-exclamation-triangle me-2"></i>Delete Media
                </h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body text-center">
                ...
                <h6 class="mb-3">Are you sure you want to delete this media?</h6>
            ...
            <div class="modal-footer border-0">
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                <form action="{{ route('media.destroy', $photo->filename) }}" method="POST" class="d-inline">
                    @csrf
                    @method('DELETE')
