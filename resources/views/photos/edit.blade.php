    ...
    $photo->albums->first() 
        ? (request()->get('from') === 'organization' && request()->get('org')
            ? [
                ...
                ['url' => route('photos.show', $photo->filename) . '?from=organization&org=' . request()->get('org'), 'label' => $photo->title],
...
<div class="container">
    <!-- Back Button -->
    <a href="{{ route('photos.show', $photo->filename) }}" class="back-btn">
    ...
    <div class="row justify-content-center">
        <div class="col-lg-8">
            <div class="edit-form-card">
                ...
                <form action="{{ route('photos.update', $photo->filename) }}" method="POST">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="action-buttons">
                        <a href="{{ route('photos.show', $photo->filename) }}" class="action-btn cancel">
